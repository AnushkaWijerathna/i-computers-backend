...
export async function searchProducts(req, res) {
  ...
  try {
    const products = await Product.find({
      //($regex→ regular expression, at least part of then name is fine) ($options : "i"→ case sensitive)
      //$elemMatch -→ Searches an array until it finds at least one element that matches the condition
